...
# Passions
## Tech 
I'm currently exploring the absolutely fascinating landscape of electrical engineering with a focus on the intersection of software and hardware:
- Embedded Engineering (in flight)
...
- VP of Engineering World Health

## Business
This intersects my passion for organization with my joy of working with people.

- childhood passion for public speaking
    -  Youth In Government (Model United Nations & Model Assembly)
    -  Mock Trial
    -  Speeches I love
- ethics & morality
...
# Background
My background:
- DevOps Engineer @ Med Dev Co
- EMT
- Emergency Department Scribe
- Medical Device Repair Tech
- VP of Engineering World Health Student Org
- Women of 'Ware (software, firmware, and hardware together 🤝) President & CoFounder

Old background (5+ years ago):
- Neuroscience wet lab research
